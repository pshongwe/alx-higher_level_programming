...
non-attacking queens on an N by N chessboard.
...
Attributes:
    ...
    solutions (list): List of solutions lists.
...
def init_board(n):
    """Initialize `n by n` chessboard with 0's."""
    board = []
...
def xout(board, row, col):
    """Mark out spots on a chessboard with x.
...
def recursive_solve(board, row, queens, solutions):
    ...
    Args:
        ...
        solutions (list): List of solution lists.
    Returns:
        solutions
    """
    if queens == len(board):
